package com.example.naamkaran.library;
...
public class RecyclerviewScroller extends LinearLayout {
    ...
    public RecyclerviewScroller(final Context context, final AttributeSet attrs, final int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        init(context);
    }

    public RecyclerviewScroller(final Context context) {
        super(context);
        init(context);
    }

    public RecyclerviewScroller(final Context context, final AttributeSet attrs) {
        super(context, attrs);
        init(context);
    }
